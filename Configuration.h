...
#define STRING_CONFIG_H_AUTHOR "(Jason Scurtu, 4Max)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 99.57 } //E1 92.6
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define RIGHT_PROBE_BED_POSITION 17 //(X_BED_SIZE - MIN_PROBE_EDGE)
